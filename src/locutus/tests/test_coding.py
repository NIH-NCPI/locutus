...
def coding_one():
    c1 = Coding(
        terminology_id="Example-Terminology",
        code="code1",
        display="Code One",
...
class TestCoding:
    ...
    def test_coding_initialization_all_fields(self, coding_one):
        ...
        assert (
            coding_one.description
            == "A Very Fine Description for the glorious term, 'code1'"
        )

    def test_delete(self, coding_one):
        assert coding_one.valid
    ...
    def test_coding_search_with_problem_chars(self):
        c1 = Coding(terminology_id="term1", code=".", display="The Dot", system="Robot")
        c1.save()

        c2 = Coding(
            terminology_id="term1", code="..", display="The Dots", system="Robot"
        )
        c2.save()

        c3 = Coding(
            terminology_id="term1", code=".term", display="The Dots", system="Robot"
        )
        c3.save()
        ...
        c5 = Coding(
            terminology_id="term1", code="/", display="The Slash", system="Robot"
        )
        c5.save()

        c6 = Coding(
            terminology_id="term1", code="/slash", display="The Slash", system="Robot"
        )
        c6.save()
        ...
        c9 = Coding(
            terminology_id="term1", code="#hash", display="The Slash", system="Robot"
        )
        c9.save()

        c10 = Coding(
            terminology_id="term1", code="ha#sh", display="The Slash", system="Robot"
        )
        c10.save()
    ...
    def test_coding_to_dict_required_fields(self):
        ...
        expected_dict = {"code": "ICD10", "display": "", "system": "ICD-10-CM"}
    ...
    def test_coding_missing_code_raises_error(self):
        ...
        with pytest.raises(
            ValueError, match="Code is a required string and cannot be empty."
        ):
    ...
    def test_coding_missing_system_raises_error(self):
        ...
        with pytest.raises(
            ValueError, match="System is a required string and cannot be empty."
        ):
