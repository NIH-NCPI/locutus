...
def test_ontology_search_success(client, seeded_ontology_apis):
    with patch(
...
def test_ontology_search_missing_keyword(client, seeded_ontology_apis):
    query = _search_query()
    del query["keyword"]
...
def test_ontology_search_missing_selected_ontologies(client, seeded_ontology_apis):
    query = _search_query()
...
def test_ontology_search_missing_selected_api(client, seeded_ontology_apis):
    query = _search_query()
...
def test_ontology_search_missing_results_per_page(client, seeded_ontology_apis):
    query = _search_query()
...
def test_ontology_search_missing_start_index(client, seeded_ontology_apis):
    query = _search_query()
...
def test_ontology_search_invalid_ontology_curie(client, seeded_ontology_apis):
    response = client.get(
        "/api/ontology_search",
